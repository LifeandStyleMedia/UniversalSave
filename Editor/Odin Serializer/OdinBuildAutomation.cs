#if UNITY_EDITOR
namespace Lasm.Bolt.UniversalSaver.OdinSerializer.Utilities.Editor
{
    using Lasm.Bolt.UniversalSaver.OdinSerializer.Editor;
    using UnityEditor;
    using UnityEditor.Build;
    using System.IO;
    using System;
    using System.Collections.Generic;
    using Lasm.Bolt.UniversalSaver.OdinSerializer.Utilities;
    ...
    public static class OdinBuildAutomation
    {
        ...
        static OdinBuildAutomation()
        {
            ...
            EditorAssemblyPath    = odinSerializerDir + "/EditorOnly/Lasm.Bolt.UniversalSaver.OdinSerializer.dll";
            AOTAssemblyPath       = odinSerializerDir + "/AOT/Lasm.Bolt.UniversalSaver.OdinSerializer.dll";
            JITAssemblyPath       = odinSerializerDir + "/JIT/Lasm.Bolt.UniversalSaver.OdinSerializer.dll";
